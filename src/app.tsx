      ...
      <div className="board-app__inner">
            ...
            <button className="add-task__button button" type="submit">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                ...
                <rect x="10.0833" y="3.66663" width="1.83333" height="14.6667"
                      fill="white"/>
                <rect x="18.3333" y="10.0833" width="1.83333" height="14.6667"
        ...
        <section className="taskboard">
          ...
          <article className="taskboard__group taskboard__group--backlog">
            <h3
              className="taskboard__group-heading taskboard__group-heading--backlog">Бэклог</h3>
            <div className="taskboard__list">
              <div className="taskboard__item task task--active">
                ...
                <button className="task__edit" type="button"
          ...
          <article className="taskboard__group taskboard__group--processing">
            <h3
              className="taskboard__group-heading taskboard__group-heading--processing">В процессе</h3>
            <div className="taskboard__list taskboard__list--sorted">
              <div className="taskboard__item task task--empty">
                <p>Перетащите карточку</p>
              </div>
              <div
                className="taskboard__item task task--processing task--active">
                <div className="task__body">
                  <p className="task__view">Название первой задачи</p>
                  <input className="task__input" type="text"
                         value="Название первой задачи"/>
          ...
          <article className="taskboard__group taskboard__group--done">
            <h3
              className="taskboard__group-heading taskboard__group-heading--done">Готово</h3>
            <div className="taskboard__list taskboard__list--sorted">
              <div className="taskboard__item task task--empty">
                <p>Перетащите карточку</p>
              </div>
          ...
          <article className="taskboard__group taskboard__group--basket">
            <h3
              className="taskboard__group-heading taskboard__group-heading--basket">Корзина</h3>
            ...
            <button className="taskboard__button button button--clear"
              ...
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                   xmlns="http://www.w3.org/2000/svg">
                <rect x="15.5374" y="5.16638" width="1.83333" height="14.6667"
                      transform="rotate(45 15.5374 5.16638)"
                      fill="white"/>
                <rect x="16.8337" y="15.5372" width="1.83333" height="14.6667"
